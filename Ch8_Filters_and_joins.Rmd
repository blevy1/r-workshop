...
Alternatively, if you’re looking for multiple matches in the same variable, you can use the %in% operator instead.
...
low_gb_wr <- fish %>% 
  filter(common_name == "garibaldi"  | common_name == "rock wrasse" & total_count<=10 )
```
...
SEE WEBSITE FOR NICE IMAGE EXPLAINING THE FOLLOWING
